`timescale 1 ns / 1 ns
//////////////////////////////////////////////////////////////////////////////////
// tb_regshadow_dh -- clock-accurate check of the CX4 overlay register-shadow capture
...
`endif
  ...
  initial begin
    ...
    $display("== OBSEL isolado, pulso longo 12 (96MHz-like) ==");
    ppu_write(8'h01,8'h30,12,10); check(8'h01,8'h30);

    $display("== OBSEL isolado, pulso curto 4 (80MHz-like) ==");
    ppu_write(8'h01,8'h30,4,10); check(8'h01,8'h30);

    $display("== BG setup TIGHT burst: $2107/$2108/$210B, pulso 4, gap 3 (o caso que quebrava) ==");
    ...
    $display("== OBSEL seguido de $21xx tight (nao contaminar) ==");
    ...
    if(errors==0) $display("\n==> PASS: raw-pulse capture correto em pulso curto/longo/burst");
    else          $display("\n==> FAIL: %0d erro(s)", errors);
    $finish;
  end
endmodule
