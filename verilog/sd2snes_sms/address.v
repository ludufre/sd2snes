...
// SMS core (M7.4b): SNES reads the translated buffers from $E0-$E3 -> PSRAM 0x380000.
//  $E0=tiles(0x0000) $E1=tilemap(0x4000) $E2=cgram(0x4800) $E3=oam(0x5000)
// (matches sms_core BUF layout; the SMS-only bitstream always maps these).
wire SMS_BUF_HIT = (SNES_ADDR[23:18] == 6'b111000);   // banks $E0..$E3
wire [23:0] sms_sel_off = (SNES_ADDR[17:16] == 2'b00) ? 24'h00000
                        : (SNES_ADDR[17:16] == 2'b01) ? 24'h04000
                        : (SNES_ADDR[17:16] == 2'b10) ? 24'h04800
                                                      : 24'h05000;
wire [23:0] sms_set_base = sms_buf_front ? 24'h390000 : 24'h380000;
wire [23:0] SMS_BUF_ADDR = sms_set_base + sms_sel_off + {8'd0, SNES_ADDR[15:0]};

assign ROM_ADDR = SMS_BUF_HIT ? SMS_BUF_ADDR : SRAM_SNES_ADDR;

assign ROM_HIT = SMS_BUF_HIT | IS_ROM | IS_WRITABLE | bs_page_enable;
