...
| <img src="gfx/diffs/patches.gif" width="320" alt="IPS/BPS patch at boot"> | **IPS/BPS patch at boot**<br>The heart of rom-hacking: apply fan translations, hacks and fixes without altering the ROM. Drop the .ips/.bps patch in the ROM's folder using the game name as a prefix; at launch the firmware lists the patches and applies it in memory, leaving the original ROM untouched. |
