...
TRANSLATIONS = {
    ...
    'text_igm_save': 'Salvar estado: Start+R',
    'text_igm_load': 'Carregar estado: Start+L',
    ...
    'mtext_ingame_sram_slots': ' {129}Slots de SRAM',
    ...
    'mdesc_ingame_sram_slots': 'Vários slots de save de bateria. A aba SAVES escolhe o slot ativo (vale no próximo boot). Desligado mantém o <rom>.srm único.',
